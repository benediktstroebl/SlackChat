...
if __name__ == "__main__":
    ...
    a1 = ToolCallingAgent(tools=[send_dm, list_channels, send_broadcast, read_dm, read_channel], model=model, max_steps=10, stream_json_logs=True, json_logs_path=f"{name}.jsonl")
    a1.run(prompt)
